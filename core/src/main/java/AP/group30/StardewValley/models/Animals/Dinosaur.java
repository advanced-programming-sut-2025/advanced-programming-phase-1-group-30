...
public class Dinosaur extends Animal {
    ...
    public Dinosaur(int price, String name, int friendship, boolean fedToday, boolean petToday, int x, int y) {
        ...
        initAnimations(GameAssetManager.getBack("dinosaur"), GameAssetManager.getFront("dinosaur"), GameAssetManager.getLeft("dinosaur"),
            GameAssetManager.getRight("dinosaur"), GameAssetManager.getEating("dinosaur"), new TextureRegion(GameAssetManager.assetManager.get(GameAssetManager.dinosaurFront1)));
    }
    @Override
