...
public enum ArtisanGoodType implements ItemsInteface {
    ...
    JUICE("juice", "A sweet, nutritious beverage.", 2 * CropType.GRAPE.getEnergy(), 4 * 13, new ArrayList<>(List.of(new Item(1, "grape", 0, ItemTexture.WOOD.getTexture()))), 2.25 * CropType.GRAPE.getBaseSellPrice(), IndustrialProductType.KEG, ItemTexture.WOOD.getTexture()),
    ...
    WINE("wine", "Drink in moderation.", 1.75 * CropType.TOMATO.getEnergy(), 7 * 13, new ArrayList<>(List.of(new Item(1, "tomato", 0, ItemTexture.WOOD.getTexture()))), 3 * CropType.TOMATO.getBaseSellPrice(), IndustrialProductType.KEG, ItemTexture.WOOD.getTexture()),
    DRIED_MUSHROOMS("dried mushrooms", "A package of gourmet mushrooms.", 50, 13, new ArrayList<>(List.of(new Item(5, "mushroom", 0, ItemTexture.WOOD.getTexture()))), CropType.MUSHROOM.getBaseSellPrice() + 25, IndustrialProductType.DEHYDRATOR, ItemTexture.WOOD.getTexture()),
    DRIED_FRUIT("dried fruit", "Chewy pieces of dried fruit.", 75, 13, new ArrayList<>(List.of(new Item(5, "tomato", 0, ItemTexture.WOOD.getTexture()))), CropType.TOMATO.getBaseSellPrice() * 25, IndustrialProductType.DEHYDRATOR, ItemTexture.WOOD.getTexture()),
    ...
    JELLY("jelly", "Gooey.", CropType.CARROT.getEnergy() * 2, 3 * 13, new ArrayList<>(List.of(new Item(1, "carrot", 0, ItemTexture.WOOD.getTexture()))), CropType.CARROT.getBaseSellPrice() + 50, IndustrialProductType.PRESERVES_JAR, ItemTexture.WOOD.getTexture()),
