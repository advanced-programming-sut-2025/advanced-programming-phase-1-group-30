...
public enum CropType implements ItemsInteface {
    BLUE_JAZZ("blue jazz", ForagingSeedType.JAZZ_SEEDS, new ArrayList<Integer>(Arrays.asList(1, 2, 2, 2)), 7, true, 1, 50, true, 45, 20, new ArrayList<Season>(Arrays.asList(Season.SPRING)), true, new ArrayList<Texture>(Arrays.asList(ItemTexture.CARROT_STAGE_1.getTexture(), ItemTexture.CARROT_STAGE_2.getTexture(), ItemTexture.CARROT_STAGE_3.getTexture(), ItemTexture.CARROT_STAGE_4.getTexture()))),
    CARROT("carrot", ForagingSeedType.CARROT_SEEDS, new ArrayList<Integer>(Arrays.asList(1, 1, 1, 1)), 4, true, 1, 35, true, 75, 33, new ArrayList<Season>(Arrays.asList(Season.SPRING)), false, new ArrayList<Texture>(Arrays.asList(ItemTexture.CARROT_STAGE_1.getTexture(), ItemTexture.CARROT_STAGE_2.getTexture(), ItemTexture.CARROT_STAGE_3.getTexture(), ItemTexture.CARROT_STAGE_4.getTexture()))),
    CAULIFLOWER("cauliflower", ForagingSeedType.CAULIFLOWER_SEEDS, new ArrayList<Integer>(Arrays.asList(1, 2, 4, 4, 1)), 12, true, 0, 175, true, 75, 33, new ArrayList<Season>(Arrays.asList(Season.SPRING)), true, new ArrayList<Texture>(Arrays.asList(ItemTexture.CARROT_STAGE_1.getTexture(), ItemTexture.CARROT_STAGE_2.getTexture(), ItemTexture.CARROT_STAGE_3.getTexture(), ItemTexture.CARROT_STAGE_4.getTexture()))),
    COFFEE_BEAN("coffee bean", ForagingSeedType.COFFEE_BEAN, new ArrayList<Integer>(Arrays.asList(1, 2, 2, 3, 2)), 10, false, 2, 15, false, 0, 0, new ArrayList<Season>(Arrays.asList(Season.SPRING, Season.SUMMER)), false, new ArrayList<Texture>(Arrays.asList(ItemTexture.CARROT_STAGE_1.getTexture(), ItemTexture.CARROT_STAGE_2.getTexture(), ItemTexture.CARROT_STAGE_3.getTexture(), ItemTexture.CARROT_STAGE_4.getTexture()))),
    ...
    BLUEBERRY("blueberry", ForagingSeedType.BLUEBERRY_SEEDS, new ArrayList<Integer>(Arrays.asList(1, 3, 3, 4, 2)), 13, false, 4, 50, true, 25, 11, new ArrayList<Season>(Arrays.asList(Season.SUMMER)), false, new ArrayList<Texture>(Arrays.asList(ItemTexture.CARROT_STAGE_1.getTexture(), ItemTexture.CARROT_STAGE_2.getTexture(), ItemTexture.CARROT_STAGE_3.getTexture(), ItemTexture.CARROT_STAGE_4.getTexture()))),
    CORN("corn", ForagingSeedType.CORN_SEEDS, new ArrayList<Integer>(Arrays.asList(2, 3, 3, 3, 3)), 14, false, 4, 50, true, 25, 11, new ArrayList<Season>(Arrays.asList(Season.SUMMER, Season.FALL)), false, new ArrayList<Texture>(Arrays.asList(ItemTexture.CARROT_STAGE_1.getTexture(), ItemTexture.CARROT_STAGE_2.getTexture(), ItemTexture.CARROT_STAGE_3.getTexture(), ItemTexture.CARROT_STAGE_4.getTexture()))),
    HOPS("hops", ForagingSeedType.HOPS_STARTER, new ArrayList<Integer>(Arrays.asList(1, 1, 2, 3, 4)), 11, false, 1, 25, true, 45, 20, new ArrayList<Season>(Arrays.asList(Season.SUMMER)), false, new ArrayList<Texture>(Arrays.asList(ItemTexture.CARROT_STAGE_1.getTexture(), ItemTexture.CARROT_STAGE_2.getTexture(), ItemTexture.CARROT_STAGE_3.getTexture(), ItemTexture.CARROT_STAGE_4.getTexture()))),
    HOT_PEPPER("hot pepper", ForagingSeedType.PEPPER_SEEDS, new ArrayList<Integer>(Arrays.asList(1, 1, 1, 1, 1)), 5, false, 3, 40, true, 13, 5, new ArrayList<Season>(Arrays.asList(Season.SUMMER)), false, new ArrayList<Texture>(Arrays.asList(ItemTexture.CARROT_STAGE_1.getTexture(), ItemTexture.CARROT_STAGE_2.getTexture(), ItemTexture.CARROT_STAGE_3.getTexture(), ItemTexture.CARROT_STAGE_4.getTexture()))),
    MELON("melon", ForagingSeedType.MELON_SEEDS, new ArrayList<Integer>(Arrays.asList(1, 2, 3, 3, 3)), 12, true, 1, 250, true, 113, 50, new ArrayList<Season>(Arrays.asList(Season.SUMMER)), true, new ArrayList<Texture>(Arrays.asList(ItemTexture.CARROT_STAGE_1.getTexture(), ItemTexture.CARROT_STAGE_2.getTexture(), ItemTexture.CARROT_STAGE_3.getTexture(), ItemTexture.CARROT_STAGE_4.getTexture(), ItemTexture.CARROT_STAGE_4.getTexture()))),
    POPPY("poppy", ForagingSeedType.POPPY_SEEDS, new ArrayList<Integer>(Arrays.asList(1, 2, 2, 2)), 7, true, 1, 140, true, 45, 20, new ArrayList<Season>(Arrays.asList(Season.SUMMER)), false, new ArrayList<Texture>(Arrays.asList(ItemTexture.CARROT_STAGE_1.getTexture(), ItemTexture.CARROT_STAGE_2.getTexture(), ItemTexture.CARROT_STAGE_3.getTexture(), ItemTexture.CARROT_STAGE_4.getTexture()))),
    RADISH("radish", ForagingSeedType.RADISH_SEEDS, new ArrayList<Integer>(Arrays.asList(2, 1, 2, 1)), 6, true, 1, 90, true, 45, 20, new ArrayList<Season>(Arrays.asList(Season.SUMMER)), false, new ArrayList<Texture>(Arrays.asList(ItemTexture.CARROT_STAGE_1.getTexture(), ItemTexture.CARROT_STAGE_2.getTexture(), ItemTexture.CARROT_STAGE_3.getTexture(), ItemTexture.CARROT_STAGE_4.getTexture()))),
    RED_CABBAGE("red cabbage", ForagingSeedType.RED_CABBAGE_SEEDS, new ArrayList<Integer>(Arrays.asList(2, 1, 2, 2, 2)), 9, true, 1, 260, true, 75, 33, new ArrayList<Season>(Arrays.asList(Season.SUMMER)), false, new ArrayList<Texture>(Arrays.asList(ItemTexture.CARROT_STAGE_1.getTexture(), ItemTexture.CARROT_STAGE_2.getTexture(), ItemTexture.CARROT_STAGE_3.getTexture(), ItemTexture.CARROT_STAGE_4.getTexture()))),
    STARFRUIT("starfruit", ForagingSeedType.STARFRUIT_SEEDS, new ArrayList<Integer>(Arrays.asList(2, 3, 2, 3, 3)), 13, true, 1, 750, true, 125, 56, new ArrayList<Season>(Arrays.asList(Season.SUMMER)), false, new ArrayList<Texture>(Arrays.asList(ItemTexture.CARROT_STAGE_1.getTexture(), ItemTexture.CARROT_STAGE_2.getTexture(), ItemTexture.CARROT_STAGE_3.getTexture(), ItemTexture.CARROT_STAGE_4.getTexture()))),
    SUMMER_SPANGLE("summer spangle", ForagingSeedType.SPANGLE_SEEDS, new ArrayList<Integer>(Arrays.asList(1, 2, 3, 1)), 8, true, 1, 90, true, 45, 20, new ArrayList<Season>(Arrays.asList(Season.SUMMER)), false, new ArrayList<Texture>(Arrays.asList(ItemTexture.CARROT_STAGE_1.getTexture(), ItemTexture.CARROT_STAGE_2.getTexture(), ItemTexture.CARROT_STAGE_3.getTexture(), ItemTexture.CARROT_STAGE_4.getTexture()))),
    SUMMER_SQUASH("summer squash", ForagingSeedType.SUMMER_SQUASH_SEEDS, new ArrayList<Integer>(Arrays.asList(1, 1, 1, 2, 1)), 6, false, 3, 45, true, 63, 28, new ArrayList<Season>(Arrays.asList(Season.SUMMER)), false, new ArrayList<Texture>(Arrays.asList(ItemTexture.CARROT_STAGE_1.getTexture(), ItemTexture.CARROT_STAGE_2.getTexture(), ItemTexture.CARROT_STAGE_3.getTexture(), ItemTexture.CARROT_STAGE_4.getTexture()))),
    ...
    TOMATO("tomato", ForagingSeedType.TOMATO_SEEDS, new ArrayList<Integer>(Arrays.asList(2, 2, 2, 2, 3)), 11, false, 4, 60, true, 20, 9, new ArrayList<Season>(Arrays.asList(Season.SUMMER)), false, new ArrayList<Texture>(Arrays.asList(ItemTexture.CARROT_STAGE_1.getTexture(), ItemTexture.CARROT_STAGE_2.getTexture(), ItemTexture.CARROT_STAGE_3.getTexture(), ItemTexture.CARROT_STAGE_4.getTexture()))),
    ...
    POWDERMELON("powdermelon", ForagingSeedType.POWDERMELON_SEEDS, new ArrayList<Integer>(Arrays.asList(1, 2, 1, 2, 1)), 7, true, 1, 60, true, 63, 28, new ArrayList<Season>(Arrays.asList(Season.WINTER)), true, new ArrayList<Texture>(Arrays.asList(ItemTexture.CARROT_STAGE_1.getTexture(), ItemTexture.CARROT_STAGE_2.getTexture(), ItemTexture.CARROT_STAGE_3.getTexture(), ItemTexture.CARROT_STAGE_4.getTexture()))),
    ...
    BANANA("banana", ForagingSeedType.BANANA_SAPLING, new ArrayList<>(Arrays.asList(7, 7, 7, 7)), 1, false, 1, 150, true, 75,0, new ArrayList<Season>(Arrays.asList( Season.SUMMER)), false, new ArrayList<Texture>(Arrays.asList(ItemTexture.CARROT_STAGE_1.getTexture(), ItemTexture.CARROT_STAGE_2.getTexture(), ItemTexture.CARROT_STAGE_3.getTexture(), ItemTexture.CARROT_STAGE_4.getTexture()))),
    MANGO("mango", ForagingSeedType.MANGO_SAPLING, new ArrayList<>(Arrays.asList(7, 7, 7, 7)), 1, false, 1, 130, true, 100, 0, new ArrayList<Season>(Arrays.asList( Season.SUMMER)), false, new ArrayList<Texture>(Arrays.asList(ItemTexture.CARROT_STAGE_1.getTexture(), ItemTexture.CARROT_STAGE_2.getTexture(), ItemTexture.CARROT_STAGE_3.getTexture(), ItemTexture.CARROT_STAGE_4.getTexture()))),
    ORANGE("orange", ForagingSeedType.ORANGE_SAPLING, new ArrayList<>(Arrays.asList(7, 7, 7, 7)), 1, false, 1, 100, true, 38, 0, new ArrayList<Season>(Arrays.asList( Season.SUMMER)), false, new ArrayList<Texture>(Arrays.asList(ItemTexture.CARROT_STAGE_1.getTexture(), ItemTexture.CARROT_STAGE_2.getTexture(), ItemTexture.CARROT_STAGE_3.getTexture(), ItemTexture.CARROT_STAGE_4.getTexture()))),
    PEACH("peach", ForagingSeedType.PEACH_SAPLING, new ArrayList<>(Arrays.asList(7, 7, 7, 7)), 1, false, 1, 140, true, 38, 0, new ArrayList<Season>(Arrays.asList( Season.SUMMER)), false, new ArrayList<Texture>(Arrays.asList(ItemTexture.CARROT_STAGE_1.getTexture(), ItemTexture.CARROT_STAGE_2.getTexture(), ItemTexture.CARROT_STAGE_3.getTexture(), ItemTexture.CARROT_STAGE_4.getTexture()))),
    ...
    private CropType(String name, ForagingSeedType source, ArrayList<Integer> stages, int totalHarvestTime,
            ...
            ArrayList<Season> seasons, boolean canBecomeGiant, ArrayList<Texture> stageTextures) {
        this.name = name;
        this.source = source;
        this.stages = stages;
        ...
        this.texture = stageTextures.getLast();
