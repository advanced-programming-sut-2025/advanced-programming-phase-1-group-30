...
public enum CropType implements ItemsInteface {
    BLUE_JAZZ("blue jazz", ForagingSeedType.JAZZ_SEEDS, new ArrayList<Integer>(Arrays.asList(1, 2, 2, 2)), 7, true, 0, 50, true, 45, 20, new ArrayList<Season>(Arrays.asList(Season.SPRING)), true, ItemTexture.WOOD.getTexture(), new ArrayList<Texture>(Arrays.asList(ItemTexture.CARROT_STAGE_1.getTexture(), ItemTexture.CARROT_STAGE_2.getTexture(), ItemTexture.CARROT_STAGE_3.getTexture(), ItemTexture.CARROT_STAGE_4.getTexture()))),
    CARROT("carrot", ForagingSeedType.CARROT_SEEDS, new ArrayList<Integer>(Arrays.asList(1, 1, 1, 1)), 3, true, 0, 35, true, 75, 33, new ArrayList<Season>(Arrays.asList(Season.SPRING)), false, ItemTexture.CARROT.getTexture(), new ArrayList<Texture>(Arrays.asList(ItemTexture.CARROT_STAGE_1.getTexture(), ItemTexture.CARROT_STAGE_2.getTexture(), ItemTexture.CARROT_STAGE_3.getTexture(), ItemTexture.CARROT_STAGE_4.getTexture()))),
    ...
    PARSNIP("parsnip", ForagingSeedType.PARSNIP_SEEDS, new ArrayList<Integer>(Arrays.asList(1, 1, 1, 1)), 4, true, 0, 35, true, 25, 11, new ArrayList<Season>(Arrays.asList(Season.SPRING)), false, ItemTexture.WOOD.getTexture(), new ArrayList<Texture>(Arrays.asList(ItemTexture.CARROT_STAGE_1.getTexture(), ItemTexture.CARROT_STAGE_2.getTexture(), ItemTexture.CARROT_STAGE_3.getTexture(), ItemTexture.CARROT_STAGE_4.getTexture()))),
    POTATO("potato", ForagingSeedType.POTATO_SEEDS, new ArrayList<Integer>(Arrays.asList(1, 1, 1, 2, 1)), 6, true, 0, 80, true, 25, 11, new ArrayList<Season>(Arrays.asList(Season.SPRING)), false, ItemTexture.WOOD.getTexture(), new ArrayList<Texture>(Arrays.asList(ItemTexture.CARROT_STAGE_1.getTexture(), ItemTexture.CARROT_STAGE_2.getTexture(), ItemTexture.CARROT_STAGE_3.getTexture(), ItemTexture.CARROT_STAGE_4.getTexture()))),
    ...
    MELON("melon", ForagingSeedType.MELON_SEEDS, new ArrayList<Integer>(Arrays.asList(1, 2, 3, 3, 3)), 12, true, 0, 250, true, 113, 50, new ArrayList<Season>(Arrays.asList(Season.SUMMER)), true, ItemTexture.WOOD.getTexture(), new ArrayList<Texture>(Arrays.asList(ItemTexture.CARROT_STAGE_1.getTexture(), ItemTexture.CARROT_STAGE_2.getTexture(), ItemTexture.CARROT_STAGE_3.getTexture(), ItemTexture.CARROT_STAGE_4.getTexture(), ItemTexture.CARROT_STAGE_4.getTexture()))),
    POPPY("poppy", ForagingSeedType.POPPY_SEEDS, new ArrayList<Integer>(Arrays.asList(1, 2, 2, 2)), 7, true, 0, 140, true, 45, 20, new ArrayList<Season>(Arrays.asList(Season.SUMMER)), false, ItemTexture.WOOD.getTexture(), new ArrayList<Texture>(Arrays.asList(ItemTexture.CARROT_STAGE_1.getTexture(), ItemTexture.CARROT_STAGE_2.getTexture(), ItemTexture.CARROT_STAGE_3.getTexture(), ItemTexture.CARROT_STAGE_4.getTexture()))),
    RADISH("radish", ForagingSeedType.RADISH_SEEDS, new ArrayList<Integer>(Arrays.asList(2, 1, 2, 1)), 6, true, 0, 90, true, 45, 20, new ArrayList<Season>(Arrays.asList(Season.SUMMER)), false, ItemTexture.WOOD.getTexture(), new ArrayList<Texture>(Arrays.asList(ItemTexture.CARROT_STAGE_1.getTexture(), ItemTexture.CARROT_STAGE_2.getTexture(), ItemTexture.CARROT_STAGE_3.getTexture(), ItemTexture.CARROT_STAGE_4.getTexture()))),
    RED_CABBAGE("red cabbage", ForagingSeedType.RED_CABBAGE_SEEDS, new ArrayList<Integer>(Arrays.asList(2, 1, 2, 2, 2)), 9, true, 0, 260, true, 75, 33, new ArrayList<Season>(Arrays.asList(Season.SUMMER)), false, ItemTexture.WOOD.getTexture(), new ArrayList<Texture>(Arrays.asList(ItemTexture.CARROT_STAGE_1.getTexture(), ItemTexture.CARROT_STAGE_2.getTexture(), ItemTexture.CARROT_STAGE_3.getTexture(), ItemTexture.CARROT_STAGE_4.getTexture()))),
    STARFRUIT("starfruit", ForagingSeedType.STARFRUIT_SEEDS, new ArrayList<Integer>(Arrays.asList(2, 3, 2, 3, 3)), 13, true, 0, 750, true, 125, 56, new ArrayList<Season>(Arrays.asList(Season.SUMMER)), false, ItemTexture.WOOD.getTexture(), new ArrayList<Texture>(Arrays.asList(ItemTexture.CARROT_STAGE_1.getTexture(), ItemTexture.CARROT_STAGE_2.getTexture(), ItemTexture.CARROT_STAGE_3.getTexture(), ItemTexture.CARROT_STAGE_4.getTexture()))),
    SUMMER_SPANGLE("summer spangle", ForagingSeedType.SPANGLE_SEEDS, new ArrayList<Integer>(Arrays.asList(1, 2, 3, 1)), 8, true, 0, 90, true, 45, 20, new ArrayList<Season>(Arrays.asList(Season.SUMMER)), false, ItemTexture.WOOD.getTexture(), new ArrayList<Texture>(Arrays.asList(ItemTexture.CARROT_STAGE_1.getTexture(), ItemTexture.CARROT_STAGE_2.getTexture(), ItemTexture.CARROT_STAGE_3.getTexture(), ItemTexture.CARROT_STAGE_4.getTexture()))),
    ...
    SUNFLOWER("sunflower", ForagingSeedType.SUNFLOWER_SEEDS, new ArrayList<Integer>(Arrays.asList(1, 2, 3, 2)), 8, true, 0, 80, true, 45, 20, new ArrayList<Season>(Arrays.asList(Season.SUMMER, Season.FALL)), false, ItemTexture.WOOD.getTexture(), new ArrayList<Texture>(Arrays.asList(ItemTexture.CARROT_STAGE_1.getTexture(), ItemTexture.CARROT_STAGE_2.getTexture(), ItemTexture.CARROT_STAGE_3.getTexture(), ItemTexture.CARROT_STAGE_4.getTexture()))),
    ...
    WHEAT("wheat", ForagingSeedType.WHEAT_SEEDS, new ArrayList<Integer>(Arrays.asList(1, 1, 1, 1)), 4, true, 0, 25, false, 0, 0, new ArrayList<Season>(Arrays.asList(Season.SUMMER, Season.FALL)), false, ItemTexture.WOOD.getTexture(), new ArrayList<Texture>(Arrays.asList(ItemTexture.CARROT_STAGE_1.getTexture(), ItemTexture.CARROT_STAGE_2.getTexture(), ItemTexture.CARROT_STAGE_3.getTexture(), ItemTexture.CARROT_STAGE_4.getTexture()))),
    AMARANTH("amaranth", ForagingSeedType.AMARANTH_SEEDS, new ArrayList<Integer>(Arrays.asList(1, 2, 2, 2)), 7, true, 0, 150, true, 50, 22, new ArrayList<Season>(Arrays.asList(Season.FALL)), false, ItemTexture.WOOD.getTexture(), new ArrayList<Texture>(Arrays.asList(ItemTexture.CARROT_STAGE_1.getTexture(), ItemTexture.CARROT_STAGE_2.getTexture(), ItemTexture.CARROT_STAGE_3.getTexture(), ItemTexture.CARROT_STAGE_4.getTexture()))),
    ARTICHOKE("artichoke", ForagingSeedType.ARTICHOKE_SEEDS, new ArrayList<Integer>(Arrays.asList(2, 2, 1, 2, 1)), 8, true, 0, 160, true, 30, 13, new ArrayList<Season>(Arrays.asList(Season.FALL)), false, ItemTexture.WOOD.getTexture(), new ArrayList<Texture>(Arrays.asList(ItemTexture.CARROT_STAGE_1.getTexture(), ItemTexture.CARROT_STAGE_2.getTexture(), ItemTexture.CARROT_STAGE_3.getTexture(), ItemTexture.CARROT_STAGE_4.getTexture()))),
    BEET("beet", ForagingSeedType.BEET_SEEDS, new ArrayList<Integer>(Arrays.asList(1, 1, 2, 2)), 6, true, 0, 100, true, 30, 13, new ArrayList<Season>(Arrays.asList(Season.FALL)), false, ItemTexture.WOOD.getTexture(), new ArrayList<Texture>(Arrays.asList(ItemTexture.CARROT_STAGE_1.getTexture(), ItemTexture.CARROT_STAGE_2.getTexture(), ItemTexture.CARROT_STAGE_3.getTexture(), ItemTexture.CARROT_STAGE_4.getTexture()))),
    BOK_CHOY("bok choy", ForagingSeedType.BOK_CHOY_SEEDS, new ArrayList<Integer>(Arrays.asList(1, 1, 1, 1)), 4, true, 0, 80, true, 25, 11, new ArrayList<Season>(Arrays.asList(Season.FALL)), false, ItemTexture.WOOD.getTexture(), new ArrayList<Texture>(Arrays.asList(ItemTexture.CARROT_STAGE_1.getTexture(), ItemTexture.CARROT_STAGE_2.getTexture(), ItemTexture.CARROT_STAGE_3.getTexture(), ItemTexture.CARROT_STAGE_4.getTexture()))),
    ...
    FAIRY_ROSE("fairy rose", ForagingSeedType.FAIRY_SEEDS, new ArrayList<Integer>(Arrays.asList(1, 4, 4, 3)), 12, true, 0, 290, true, 45, 20, new ArrayList<Season>(Arrays.asList(Season.FALL)), false, ItemTexture.WOOD.getTexture(), new ArrayList<Texture>(Arrays.asList(ItemTexture.CARROT_STAGE_1.getTexture(), ItemTexture.CARROT_STAGE_2.getTexture(), ItemTexture.CARROT_STAGE_3.getTexture(), ItemTexture.CARROT_STAGE_4.getTexture()))),
    ...
    PUMPKIN("pumpkin", ForagingSeedType.PUMPKIN_SEEDS, new ArrayList<Integer>(Arrays.asList(1, 2, 3, 4, 3)), 13, true, 0, 320, false, 0, 0, new ArrayList<Season>(Arrays.asList(Season.FALL)), true, ItemTexture.WOOD.getTexture(), new ArrayList<Texture>(Arrays.asList(ItemTexture.CARROT_STAGE_1.getTexture(), ItemTexture.CARROT_STAGE_2.getTexture(), ItemTexture.CARROT_STAGE_3.getTexture(), ItemTexture.CARROT_STAGE_4.getTexture()))),
    YAM("yam", ForagingSeedType.YAM_SEEDS, new ArrayList<Integer>(Arrays.asList(1, 3, 3, 3)), 10, true, 0, 160, true, 45, 20, new ArrayList<Season>(Arrays.asList(Season.FALL)), false, ItemTexture.WOOD.getTexture(), new ArrayList<Texture>(Arrays.asList(ItemTexture.CARROT_STAGE_1.getTexture(), ItemTexture.CARROT_STAGE_2.getTexture(), ItemTexture.CARROT_STAGE_3.getTexture(), ItemTexture.CARROT_STAGE_4.getTexture()))),
    SWEET_GEM_BERRY("Sweet Gem Berry", ForagingSeedType.RARE_SEED, new ArrayList<Integer>(Arrays.asList(2, 4, 6, 6, 6)), 24, true, 0, 3000, false, 0, 0, new ArrayList<Season>(Arrays.asList(Season.FALL)), false, ItemTexture.WOOD.getTexture(), new ArrayList<Texture>(Arrays.asList(ItemTexture.CARROT_STAGE_1.getTexture(), ItemTexture.CARROT_STAGE_2.getTexture(), ItemTexture.CARROT_STAGE_3.getTexture(), ItemTexture.CARROT_STAGE_4.getTexture()))),
    POWDERMELON("powdermelon", ForagingSeedType.POWDERMELON_SEEDS, new ArrayList<Integer>(Arrays.asList(1, 2, 1, 2, 1)), 7, true, 0, 60, true, 63, 28, new ArrayList<Season>(Arrays.asList(Season.WINTER)), true, ItemTexture.WOOD.getTexture(), new ArrayList<Texture>(Arrays.asList(ItemTexture.CARROT_STAGE_1.getTexture(), ItemTexture.CARROT_STAGE_2.getTexture(), ItemTexture.CARROT_STAGE_3.getTexture(), ItemTexture.CARROT_STAGE_4.getTexture()))),
